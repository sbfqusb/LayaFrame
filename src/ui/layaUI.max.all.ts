...
module ui.test {
    export class alphaoutUI extends laya.display.EffectAnimation {
        ...
        public static  uiView:any ={"type":"View","props":{},"child":[{"type":"Image","props":{"y":-130,"x":-88,"skin":"comp/image.png"},"compId":2}],"animations":[{"nodes":[{"target":2,"keyframes":{"y":[{"value":-130,"tweenMethod":"linearNone","tween":true,"target":2,"key":"y","index":0},{"value":-128,"tweenMethod":"linearNone","tween":true,"target":2,"key":"y","index":10}],"x":[{"value":-88,"tweenMethod":"linearNone","tween":true,"target":2,"key":"x","index":0},{"value":-75,"tweenMethod":"linearNone","tween":true,"target":2,"key":"x","index":10}],"alpha":[{"value":1,"tweenMethod":"linearNone","tween":true,"target":2,"key":"alpha","index":0},{"value":0.5,"tweenMethod":"linearNone","tween":true,"target":2,"key":"alpha","index":5},{"value":0,"tweenMethod":"linearNone","tween":true,"target":2,"key":"alpha","index":10}]}}],"name":"ani1","id":1,"frameRate":24,"action":0}]};
...
module ui.test {
    export class tipsUI extends View {
		public mTips:laya.html.dom.HTMLDivElement;

        public static  uiView:any ={"type":"View","props":{"width":640,"height":1136},"child":[{"type":"Panel","props":{"width":640,"mouseThrough":true,"mouseEnabled":false,"centerY":0,"centerX":0},"child":[{"type":"HTMLDivElement","props":{"width":640,"var":"mTips","innerHTML":"<span style = 'color:#fff6cf;font:18px simHei'>这个地方是否用内存池，自行判断</span>","height":100}}]}]};
        constructor(){ super()}
        createChildren():void {
