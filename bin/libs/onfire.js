...
!function (root, factory) {
    ...
    // else
    onfire = root.onfire = factory();
}(typeof window !== 'undefined' ? window : this, function () {
    var __onfireEvents = {}, __cnt = 0, // evnet counter
    string_str = 'number', function_str = 'function', hasOwnKey = Function.call.bind(Object.hasOwnProperty), slice = Function.call.bind(Array.prototype.slice);
